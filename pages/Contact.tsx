              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full bg-dark-900 border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-tech-500 transition-colors"
                ...
                <button
                  type="submit"
                  className="w-full bg-tech-600 hover:bg-tech-700 text-white font-medium py-2 px-4 rounded-lg transition-colors flex items-center justify-center"
                >
                  <Send className="w-4 h-4 mr-2" />
                  Send Message
                </button>
                <p className="text-xs text-gray-500 text-center">
                  Your message will be sent directly to {PERSONAL_INFO.email}
                </p>
              </form>
            </div>
          </div>
