...
import { PROJECTS, PERSONAL_INFO, WORK_EXPERIENCE } from '../constants';
...
const Portfolio: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-dark-900">
      ...
      <div className="bg-gradient-to-b from-dark-900 via-dark-800 to-dark-900 py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Work <span className="text-transparent bg-clip-text bg-gradient-to-r from-tech-500 to-art-500">Experience</span>
            </h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              My professional journey in the world of 3D art and technical development
            </p>
            <div className="mt-6 w-24 h-1 bg-gradient-to-r from-tech-500 to-art-500 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="flex flex-wrap gap-2 mt-4 md:mt-0">
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 border ${filter === cat
